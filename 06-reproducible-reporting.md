...
<!-- TODO: add episodes/files/xander-bogaerts-report-template.Rmd — the
     full multi-page R Markdown capstone referenced in Episode 1's opening.
     Scaffold only for now; template to be written closer to delivery. -->

The capstone of this course is a single R Markdown file that produces a
polished, multi-page PDF report at the press of the Knit button. The worked
example is the Xander Bogaerts baseball statistics report you saw in
Episode 1's opening — the same file, opened now with the skills from this
episode in hand.

The full template lives at
`episodes/files/xander-bogaerts-report-template.Rmd`. The instructor will
walk through its structure: a YAML header, a hidden setup chunk, a small
number of analysis chunks, and prose with inline R for the narrative
numbers. Everything above in this episode is inside that template — the
capstone is assembly, not new material.
