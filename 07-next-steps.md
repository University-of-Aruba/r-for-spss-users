...
The four-hour format has no open lab slot, so this section is yours to work
through after the course, on the [homework brief](homework.html) script you
built between the two sessions. If the room is ahead of schedule the instructor
may take one or two of these live instead.

Open your homework script and look at three things: what you built, any errors
you kept in a comment at the top, and one thing you would still like the script
to do. Then pick a target below.
